...
(function($) {
    ...
    **/
    var launch = new Date(2018, 08, 03, 00, 00);
    /**
    * The script
    **/
    var message = $('#message');
    ...
    function setDate(){
        ...
        if( launch < now ){
            ...
            message.html('THEY ARE GETTING MARRIED!');
        }
        else{
            ...
            message.html('... COULD BE MARRYING ANY DAY NOW! WHO KNOWS WHAT THIS COUNT-DOWN IS FOR?');
        }
    }
})(jQuery);
/******************************************************************************************************************************
